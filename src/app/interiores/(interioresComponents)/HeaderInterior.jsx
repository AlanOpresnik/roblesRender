          ...
          <div className="container mx-auto flex px-5 py-12 md:py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <div className="flex justify-center">
                ...
                <Link href={'/interiores/360'} className="inline-flex mb-6 ml-4 md:mb-0  bg-[#ededed] text-[#374151] border-0 py-2 px-6 focus:outline-none hover:bg-[#E5E7EB] rounded text-lg">
                  Ver interior 360
                </Link>
              </div>
            </div>
