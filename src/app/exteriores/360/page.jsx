...
import ImageViewerExterior from '@/components/imageViewer/ImageViewerExterior';
        ...
        <>
          <div className='md:w-[600px] lg:w-[800px] px-2'>
            <div className='py-6 w-auto px-2'>
              <h3 className='text-2xl font-bold text-center'>Exterior <span className='text-[#4C7CD3]'>360°</span></h3>
